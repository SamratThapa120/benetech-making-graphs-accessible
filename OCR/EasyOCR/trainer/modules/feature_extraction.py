...
class ResNet2(nn.Module):
    def __init__(self, input_channel, output_channel,block, layers):
        ...
        # Use pretrained ResNet50 from torchvision
        ...
        # Change the first layer if the input channel is not 3
        if input_channel != 3:
            self.resnet.conv1 = nn.Conv2d(input_channel, 64, kernel_size=7, stride=2, padding=3, bias=False)
